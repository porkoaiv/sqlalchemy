# dialects/vertica/__init__.py
# Copyright (C) 2005-2024 the SQLAlchemy authors and contributors
# <see AUTHORS file>
#
# This module is part of SQLAlchemy and is released under
# the MIT License: https://www.opensource.org/licenses/mit-license.php
# mypy: ignore-errors 2

from types import ModuleType

from . import array as arraylib  # noqa # keep above base and other dialects
# from . import asyncv  # noqa
from . import base
# from . import v8000  # noqa
# from . import psycov  # noqa
# from . import psycov2  # noqa
# from . import psycov2cffi  # noqa
...
from . import vertica_python  # noqa
# Alias psycov also as psycov_async
# psycov_async = type(
#     "psycov_async", (ModuleType,), {"dialect": psycov.dialect_async}
# )
#
base.dialect = dialect = vertica_python.dialect

from .base import LONGVARCHAR, LONGVARBINARY, max_long_varchar_length
