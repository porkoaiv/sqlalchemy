...
class HSTORE(sqltypes.Indexable, sqltypes.Concatenable, sqltypes.TypeEngine):
    """Represent the Vertica HSTORE type.
    ...
    * Concatenation::
    ...
    .. seealso::
        ...
        :class:`.hstore` - render the Vertica ``hstore()`` function.
...
class hstore(sqlfunc.GenericFunction):
    ...
    E.g.::
        ...
        from sqlalchemy.dialects.vertica import array, hstore
    ...
    .. seealso::
        ...
        :class:`.HSTORE` - the Vertica ``HSTORE`` datatype.
...
#
# parsing.  note that none of this is used with the psycov2 backend,
# which provides its own native extensions.
#

# My best guess at the parsing rules of hstore literals, since no formal
# grammar is given.  This is mostly reverse engineered from Vertica's input parser
# behavior.
...
def _parse_hstore(hstore_str):
    ...
    Attempts to approximate Vertica's hstore input parsing rules as closely as
